...
# from tf.keras.layers.Flatten import flatten
...
potholeTrainImages = glob.glob("D:/Pepcoding/ML/PotholeDetectionSystem/pothole-detection-system-using-convolution-neural-networks-master/pothole-detection-system-using-convolution-neural-networks-master/My Dataset/train/Pothole/*.jpg")
potholeTrainImages.extend(glob.glob("D:/Pepcoding/ML/PotholeDetectionSystem/pothole-detection-system-using-convolution-neural-networks-master/pothole-detection-system-using-convolution-neural-networks-master/My Dataset/train/Pothole/*.jpeg"))
potholeTrainImages.extend(glob.glob("D:/Pepcoding/ML/PotholeDetectionSystem/pothole-detection-system-using-convolution-neural-networks-master/pothole-detection-system-using-convolution-neural-networks-master/My Dataset/train/Pothole/*.png"))
...
nonPotholeTrainImages = glob.glob("D:/Pepcoding/ML/PotholeDetectionSystem/pothole-detection-system-using-convolution-neural-networks-master/pothole-detection-system-using-convolution-neural-networks-master/My Dataset/train/Plain/*.jpg")
